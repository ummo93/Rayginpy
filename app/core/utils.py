from pyray import Color, rl_begin, rl_vertex2f, rl_color4ub, rl_end, rl_set_line_width
from raylib.defines import RL_LINES


def draw_lines_batch(segments: list[tuple[float, float]], color: Color, fade: bool = False, fade_str: int = 1, width: float = 1.0):
